...
export function StatePanel({ icon: Icon, message }: { icon: LucideIcon; message: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/30 px-6 py-24 text-center">
      ...
      <p className="mt-4 max-w-sm text-sm text-muted-foreground text-pretty">{message}</p>
    </div>
  )
}
